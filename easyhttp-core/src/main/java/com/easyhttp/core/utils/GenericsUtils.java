...
public class GenericsUtils {
    ...
    public static Class getSuperClassGenricTypeClazz(Class clazz, int index) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static Class getSuperClassGenricTypeClazz(Class clazz) {

        return getSuperClassGenricTypeClazz(clazz, 0);
    }
    ...
    public static <T> Class<T> getGenericsClass(Object object, int typeIndex) {
