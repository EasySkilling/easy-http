...
import com.easyhttp.dep.annotations.methods.Delete;
import com.easyhttp.dep.annotations.methods.Get;
import com.easyhttp.dep.annotations.methods.Patch;
import com.easyhttp.dep.annotations.methods.Post;
import com.easyhttp.dep.annotations.methods.Put;
...
@SupportedAnnotationTypes({
        "com.easyhttp.dep.annotations.Api"
})
public class ApiProcessor extends AbsProcessor {
    ...
    private void generateEasyApiClass(TypeElement apiElement, String baseUrl, boolean supportMultipleDomain) {
        ...
        JavaFile javaFile = JavaFile
                .builder(GenerateRules.generateEasyApiClazzNamePkg(), clazzBuilder.build())
                .build();
        try {
            // 输出文件
        ...
        if (!executableElements.isEmpty()) {
            for (ExecutableElement method : executableElements) {
                ...
                methodBuilder.addStatement(
                        ...
                        ClassName.get(elementUtils.getTypeElement(DepApiConst.CORE_HTTP_EXECUTOR_PATH)),
                        executeParamsName,
